...
for i in range(3):
    ...
    if  user not in up_dict.keys() or up_dict[user] != password:
        print('Nezadali jste správnou kombinaci jména a hesla. Zkuste to znovu')
        print('Zbývající počet pokusů: ', 3-i-1)
    else:
        break
else:
    print('Povolený počet pokusů pro přihlášení byl překročen')
    print('Program musí být bohužel ukončen')
    exit()
